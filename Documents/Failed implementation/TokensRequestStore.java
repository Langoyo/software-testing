...
public class TokensRequestStore extends genericStore implements IStore{
...
//			System.out.println("Token Store Object cannot be cloned");
	...
	public void saveValue(TokenRequest req, String Value) throws TokenManagementException {
	...
	public Object Find (String tokenValue) throws TokenManagementException{
        ...
        if (clonedMap==null) {
        	...
        	return clonedMap.get(tokenValue);
        }
	}
